...
features: []
genres: []
key: one-on-one-to-be-continued---
lyrics_url: https://genius.com/To-be-continued-one-on-one-lyrics
name: One On One
rankings:
- end_date: '1994-01-28'
  rank: 94
...
We can make it if we try (love one by one)
Love (love one by one)
Love one by one
Love one by one
