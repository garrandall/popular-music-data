...
features: []
genres: []
key: did-it-on-em-nicki-minaj
lyrics_url: https://genius.com/Nicki-minaj-did-it-onem-lyrics
name: Did It On'em
rankings:
- end_date: '2011-03-25'
  rank: 92
...
All these bitches is my sons (my sons)
And I'mma go and get some bibs for 'em
A couple formulas, little pretty lids on 'em
If I had a dick, I would pull it out and piss on 'em (psss)
...
Y-y-you my seed, I spray you with the germinator (sh-sh-sh-sh-sh)
