...
I'mma go pop the trunk and turn the street volume up to ten
...
I can't help it if the club only packing a G
And the fire marshal wanna shut it down in 3
And you balling ass niggas, whose dressed to kill
...
Like a three o'clock bully, waiting after school
...
Poppa Bear at the table, and the porridge is pouring
...
Say let's get dirty (let's get dirty)
If you swinging from them club lights (let's get dirty)
Say let's get dirty (let's get dirty)
...
Everybody jump up and down (let's get dirty)
Say let's get dirty (let's get dirty)
Everybody keep it going now (let's get dirty)
Say let's get dirty (let's get dirty)
