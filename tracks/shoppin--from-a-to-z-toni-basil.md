...
features: []
genres: []
key: shoppin--from-a-to-z-toni-basil
lyrics_url: https://genius.com/Toni-basil-shoppin-from-a-to-z-lyrics
name: Shoppin' From A To Z
rankings:
- end_date: '1983-03-04'
  rank: 83
...
F (fish) G (garlic) H (hairspray)
I (ice) J (junkfood) K (ketchup)
L (liver) M (matzoh) N (nuts)
O (onion) P (pizza) Q (qiuche)
R (relish) S (soap) T (tuna)
